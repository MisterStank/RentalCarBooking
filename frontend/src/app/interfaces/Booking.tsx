// To parse this data:
//
//   import { Convert, Booking } from "./file";
//
...
export class Convert {
    public static toBooking(json: string): Booking {
        return cast(JSON.parse(json), r("Booking"));
    }

    public static bookingToJson(value: Booking): string {
        return JSON.stringify(uncast(value, r("Booking")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    Datum: o(
        [
            { json: "_id", js: "_id", typ: "" },
            { json: "pickupDate", js: "pickupDate", typ: Date },
